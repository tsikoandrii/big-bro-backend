...
export interface ApiMasterMaster extends Schema.CollectionType {
  ...
  attributes: {
    ...
    morning: Attribute.DynamicZone<['day.working-hour']>;
    day: Attribute.DynamicZone<['day.working-hour']>;
    evening: Attribute.DynamicZone<['day.working-hour']>;
    busy: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiWeekendWeekend extends Schema.CollectionType {
